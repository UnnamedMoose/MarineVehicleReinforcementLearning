...
rov = BlueROV2Heavy6DoF(BlueROV2Heavy6DoF_PID_controller(dfWps.loc[1, DOFs].values))
...
for result_solve_ivp in history:
    ...
    for i, v in enumerate(["x", "y", "z", "phi", "theta", "psi"]):
        ...
        ax.hlines(rov.controller.setPoint[i], result_solve_ivp.t[0]+tTot, result_solve_ivp.t[-1]+tTot,
